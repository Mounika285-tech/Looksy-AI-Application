...
export const WeatherStylingResultScreen = ({ navigation, route }) => {
  ...
  const fallbacks = {
    top: {
      id: 'fb_w_top',
      name: isWarm ? 'Light Poplin Linen Shirt' : 'Ivory Silk Button-Down',
      category: 'Top Wear',
    ...
    bottom: {
      id: 'fb_w_bottom',
      name: isWarm ? 'Pleated Linen Shorts' : 'Wide-Leg Wool Trousers',
    ...
    foot: {
      id: 'fb_w_foot',
      name: isWarm ? 'Minimalist Slide Sandals' : 'Pointed Leather Pumps',
      category: 'Footwear',
    ...
    outerwear: {
      id: 'fb_w_outer',
      name: isCold ? 'Oversized Wool Blend Coat' : 'Classic Camel Trench Coat',
  ...
  const createFallbackOutfit = () => {
    ...
    if (!isWarm) {
      outfit.items.accessory = fallbacks.outerwear;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.breakdownSection}>
          ...
          {curatedOutfit.items.top && (
            <View style={styles.itemRow}>
              ...
              <View style={styles.rowMeta}>
                <Text style={styles.rowCategory}>The Base Layer</Text>
          ...
          {curatedOutfit.items.bottom && (
            <View style={styles.itemRow}>
              ...
              <View style={styles.rowMeta}>
                <Text style={styles.rowCategory}>The Bottoms</Text>
          ...
          {curatedOutfit.items.footwear && (
            <View style={styles.itemRow}>
              ...
              <View style={styles.rowMeta}>
                <Text style={styles.rowCategory}>The Footwear</Text>
          ...
          {curatedOutfit.items.accessory && (
            <View style={styles.itemRow}>
              ...
              <View style={styles.rowMeta}>
                <Text style={styles.rowCategory}>Outerwear</Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text style={styles.actionBtnText}>Wear This Today</Text>
